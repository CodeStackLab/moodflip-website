...
**Developer Response — Sohel (27 July 2026\)**

Hi Joy, thanks for the detailed review. Here are my confirmed responses to all open items and comments in this document, point by point.

**1\) Communication & Process**

All communication will stay on Fiverr. Development is considered complete only after: (a) the test version is delivered, (b) you've had your approximately one-week testing window and sent your consolidated bug/feedback report, and (c) I've corrected all reported issues and modifications that fall within this Business Specification v3. moodflip.coach will go live only after this process is completed and approved by you. This matches Section 22 of this spec and the Test Mode SLA (bugs fixed within 2 working days during testing).

**2\) One Master Document**

Agreed — Business Specification v3 is our single reference from now on. This response is added into this same document, as requested.

**3\) Source Code / Repository Ownership**

The code will live in a private GitHub repository. Same principle as Vercel and Supabase: at handover you'll be added as Owner of that repository (or it's transferred to a GitHub account you control), and I'll be removed or kept only as a temporary collaborator if you want ongoing support. The transfer covers hosting, database, and the actual repository — not just the live site. Environment variables and settings will be documented as part of the handover.

**4\) Phase 1 & Phase 2 Scope**

Confirmed — both Phase 1 and Phase 2 are included in the original order you have already paid for. No additional payment will be required to develop and launch Phase 2, including the 30-day tracking and PDF product, support for 30+ actions per mood using the content you provide, and AdSense activation after approval.

**5\) Live Support SLA**

Confirmed — high-priority live bugs (site down, payment not working, etc.) fixed within 24 hours, low-priority issues within 48 hours, at no extra cost, for the free 1-year maintenance period after launch.

**6\) Bug Fixes After Launch**

Included at no additional cost for the first year. After that, maintenance is optional at $50 for any month you need updates or fixes, with no fixed monthly commitment.

**7\) Adding More Actions (+25 per mood)**

Included as part of Phase 2 at no additional cost, per item 4 above — I'll load the extra actions once you supply the content.

**8\) 30-Day PDF Launch**

Included as part of Phase 2 at no additional cost, per item 4 above.

**9\) Search Console Issues**

Initial Search Console setup, sitemap submission and indexing request are included. After launch, if Search Console flags an indexing or technical SEO error, I'll check and fix it under the free 1-year maintenance when it's reported. This isn't a proactive daily SEO monitoring service — let me know if you'd like that as a separate add-on.

**10\) AdSense Integration Later**

The site will be AdSense-ready at launch (structure, required pages, original content, ad space). Once Google approves the site, adding the approved AdSense code is included in the free 1-year maintenance window, as part of Phase 2\.

**11\) Hosting Upgrades**

No cost while on the free tier. If/when needed: Vercel Pro ≈ $20/month, Supabase Pro ≈ $25/month — these are your own subscription costs, not a fee from me. Nothing gets upgraded without your prior approval, and there's no separate charge on my side just for facilitating it, unless real migration work is needed, which I'd quote first.

**12\) Capacity Planning & Monitoring**

Free-tier limits: Vercel \~100GB bandwidth/month; Supabase 500MB database \+ 50,000 monthly active users \+ 5GB bandwidth/month — comfortable for launch and early growth. Monitoring schedule: weekly checks in month 1 after launch, then monthly while stable, plus immediate checks any time there's a payment, PDF, profile, or site-access issue.

**13\) Backups (Supabase Free)**

Supabase Free doesn't include automatic backups. I'll provide one full manual database/content export (CSV) at launch as your starting backup. You can also export tables yourself anytime from the Supabase dashboard (Table Editor → Export CSV). If you want ongoing automatic backups, Supabase Pro ($25/month) includes 7-day backups.

**14\) Payment / PDF Failure Handling**

Confirmed — if payment succeeds but PDF generation or email delivery fails, the purchase is still recorded and you keep access. The admin dashboard lets you regenerate/resend the PDF or grab a secure download link.

**15\) Ownership After Payment**

Confirmed — full ownership of source code, design, written content, the mood/action database, and all commercial rights, plus documentation and full deployment/account access. Just to clear up the "final payment" wording elsewhere in this document — that refers to the Fiverr order you already paid in full on 19 July, not a new or additional charge.

**I confirm and agree with all of the above. Thank you.**
