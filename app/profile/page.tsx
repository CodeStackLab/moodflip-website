            ...
            {!paymentSuccess ? (
              ...
              <div className="text-center py-6 space-y-4">
                ...
                <div>
                  ...
                  <p className="text-xs text-[#7464AC] font-medium mt-2 max-w-xs mx-auto">
                    Payment received. Your report is being prepared. If it does not arrive, you can download it from your profile or contact support.
                  </p>
                </div>
                <div className="pt-2">
                  <button
