  ...
  return (
    <div className="min-h-screen bg-[#FDFBF7] text-[#2D264B]">
      ...
      <main className="mx-auto max-w-[1240px] px-6 py-8">
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_460px] gap-6 items-stretch min-h-[560px]">
          ...
          <div className="relative overflow-hidden rounded-3xl border border-[#EAE3D6] p-8 md:p-10 flex flex-col justify-between shadow-sm bg-gradient-to-b from-[#FFF2F8] via-[#FFF9EA] to-[#FFF4FA]">
            ...
            {/* Sunset Sun Graphic */}
            <div className="relative w-full h-48 my-5 rounded-2xl bg-gradient-to-b from-white/60 to-[#FFFEF2] border border-[#F0DCF0] flex items-center justify-center overflow-hidden">
              <div className="w-20 h-20 rounded-full bg-gradient-to-br from-[#FFF7D6] via-[#FFCF75] to-[#EF9C4E] shadow-[0_0_40px_rgba(255,180,100,0.6)]" />
            </div>
          ...
          <div className="rounded-3xl border border-[#EAE3D6] bg-white p-8 md:p-9 shadow-sm flex flex-col justify-center text-center">
            ...
            <p className="text-xs font-bold text-[#7147E8] mb-5">
              Sign in to MoodFlip
            </p>
        ...
        <section className="mt-6 p-4 md:px-7 rounded-2xl border border-[#EAE3D6] bg-white flex flex-col md:flex-row items-center justify-between gap-4 text-xs text-[#443C60] shadow-sm">
          <div className="flex items-center gap-3">
            <span className="w-9 h-9 rounded-lg bg-[#E8DCFF] grid place-items-center text-lg">🛡️</span>
            <span>We use industry-standard encryption to keep your data safe and your mind at ease.</span>
          </div>
          <div className="flex flex-wrap gap-4 text-[11px] font-semibold text-[#554A78]">
