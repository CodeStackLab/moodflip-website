          ...
          <div style={{
            ...
            <div style={{
              ...
              <div style={{ textAlign: 'center' }}>
                ...
                <span style={{ fontSize: '9px', color: '#736b85', lineHeight: '1.2', display: 'block' }}>Your data is encrypted and protected.</span>
              </div>
              ...
              <div style={{ textAlign: 'center' }}>
                ...
                <span style={{ fontSize: '9px', color: '#736b85', lineHeight: '1.2', display: 'block' }}>Supporting your mental well-being</span>
              </div>
              ...
              <div style={{ textAlign: 'center' }}>
                ...
                <span style={{ fontSize: '9px', color: '#736b85', lineHeight: '1.2', display: 'block' }}>Your privacy comes first</span>
              </div>
            </div>
          </div>
...
console.log('LoginPage written successfully!');
