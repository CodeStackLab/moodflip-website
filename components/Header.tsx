...
export default function Header() {
  ...
  return (
    <header className="sticky top-0 z-50 border-b border-[#E4DAD7] bg-[#FDF8F5]/95 backdrop-blur-md">
      <div className="mx-auto max-w-[1280px] px-4 sm:px-6 lg:px-8 h-16 sm:h-18 flex items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-3 shrink-0">
          ...
          >
            {menuOpen ? (
              <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.4" strokeLinecap="round" strokeLinejoin="round"><line x1="18" y1="6" x2="6" y2="18"/><line x1="6" y1="6" x2="18" y2="18"/></svg>
            ) : (
              <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.4" strokeLinecap="round" strokeLinejoin="round"><line x1="3" y1="12" x2="21" y2="12"/><line x1="3" y1="6" x2="21" y2="6"/><line x1="3" y1="18" x2="21" y2="18"/></svg>
            )}
          </button>
        </div>
      </div>
      ...
      {/* MOBILE DROPDOWN */}
      {menuOpen && (
        <nav className="md:hidden flex flex-col p-4 bg-[#FEFAF8]/98 backdrop-blur-xl border-t border-[#E4DAD7] shadow-xl animate-in slide-in-from-top-2 duration-200 gap-1.5">
          <div className="flex flex-col gap-1">
            <Link href="/" onClick={() => setMenuOpen(false)} className="flex items-center gap-3 p-3 rounded-xl text-[#1A143F] font-bold text-sm hover:bg-[#F4EBF5] hover:text-[#7464AC] transition">
              <span className="w-6 text-center text-lg">🏠</span> Mood Tool
            </Link>
          ...
          <div className="flex flex-col gap-2 mt-2 pt-3 border-t border-[#E4DAD7]">
            <Link href="/login" onClick={() => setMenuOpen(false)} className="flex items-center justify-center gap-2 h-11 rounded-xl bg-[#F4EBF5] text-[#7464AC] font-bold text-sm border border-[#E4DAD7] hover:bg-[#EEE0FC] transition">
            ...
            <a
              ...
              className="flex items-center justify-center gap-2 h-11 rounded-xl bg-gradient-to-r from-[#7464AC] to-[#4F438B] text-white font-bold text-sm shadow-md cursor-pointer hover:opacity-95 transition"
            >
