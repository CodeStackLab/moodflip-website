...
export default function MobileBottomNav() {
  ...
  return (
    <>
      {/* Sleek App Bottom Navigation Bar (Mobile Only - Hidden on Tablets and Desktops) */}
      <nav
        className="sm:hidden landscape:hidden fixed bottom-0 left-0 right-0 z-40 bg-[#FEF9F5]/96 backdrop-blur-xl border-t border-[#E4DAD7] shadow-[0_-4px_20px_rgba(26,20,63,0.06)] px-2 py-1.5"
