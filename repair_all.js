...
// 1. Write clean TSX for app/login/page.tsx
...
// 2. Restore full height on dashboard columns in app/page.module.css
let css = fs.readFileSync('app/page.module.css', 'utf8');

// Restore dashboard grid align-items to stretch & height 100%
css = css.replace(
  /\.dashboard\s*\{[^}]*\}/s,
  `.dashboard {
  display: grid;
...
console.log('Repaired login page TSX & restored full height for dashboard columns in CSS!');
