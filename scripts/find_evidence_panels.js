...
async function main() {
  ...
  // Find Evidence Panel A & B
  const posA = fullDocText.indexOf('Evidence Panel A');
  if (posA !== -1) {
    console.log('--- Evidence Panel A context ---');
    console.log(fullDocText.substring(posA, posA + 600));
  }

  const posB = fullDocText.indexOf('Evidence Panel B');
  if (posB !== -1) {
    console.log('\n--- Evidence Panel B context ---');
    console.log(fullDocText.substring(posB, posB + 600));
  }
}
