...
fs.writeFileSync('scripts/inspect_all_recent.ps1', psScript);
const output = execSync('powershell -ExecutionPolicy Bypass -File scripts/inspect_all_recent.ps1').toString();
console.log(output);
