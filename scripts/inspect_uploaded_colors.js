...
// We can read PNG pixels using pure JS or Jimp / sharp or canvas or powershell System.Drawing.Bitmap
const psScript = `
...
fs.writeFileSync('scripts/inspect_uploaded_colors.ps1', psScript);
const output = execSync('powershell -ExecutionPolicy Bypass -File scripts/inspect_uploaded_colors.ps1').toString();
console.log(output);
